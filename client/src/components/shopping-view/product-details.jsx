...
function ProductDetailsDialog({ open, setOpen, productDetails }) {
  ...
  function handleAddReview() {
    // console.log("Frontend userId", user);
    ...
    dispatch(addReview({
      ...
      .then(data => {
        if (data?.payload?.success) {
          ...
          toast({
            title: "You already reviewed this product. You cannot give any more reviews!",
            variant: 'destructive'
          })
          return;
        }
  ...
  return (
    <Dialog open={open} onOpenChange={handleDialogClose} >
      <DialogContent className="grid grid-cols-2 gap-8 max-h-95vh sm:p-12 max-w-[90vw] sm:max-w-[80vw] lg:max-w-[70vw]">
