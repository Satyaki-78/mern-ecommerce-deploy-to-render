import { House, LogOut, Menu, Search, ShoppingCart, UserCog } from "lucide-react";
      ...
      {shoppingViewHeaderMenuItems.map((menuItem) => {
        return menuItem.id === "search" ? (
          ...
          <Label
            key={menuItem.id}
            onClick={() => handleNavigate(menuItem)}
            className="relative text-md font-medium cursor-pointer inline-block
